...
class Captcha:
    def __init__(self, width=150, height=30, code_count=5, font_size=28, point_count=20, line_count=3,
                 img_format='png'):
        '''
    ...
    def getValidCodeImg(self):
        ...
        font = ImageFont.truetype("tahoma.ttf", size=self.font_size)
        ...
        for i in range(self.code_count):
            ...
            # draw.text((10 + i * 30, -2), random_char, self.getRandomColor())
